...
// The 4 sections inside the diagnostics modal:
//   - ToolCatalogSection   live tool ids + drift vs static ToolName
//   - McpServersSection    MCP server connection map
//   - ConfigSection        effective opencode.json post-merge
//   - CommandsSection      user-defined commands
//
// Plus the shared Section chrome (title + count + eyebrow) and a small
// EmptyHint placeholder. Lifted from diagnostics-modal.tsx 2026-04-28
// so the modal entry-point file is just the modal scaffolding.
...
export function ToolCatalogSection({ directory }: { directory: string }) {
...
export function McpServersSection({ directory }: { directory: string }) {
...
export function ConfigSection({ directory }: { directory: string }) {
...
export function CommandsSection({ directory }: { directory: string }) {
