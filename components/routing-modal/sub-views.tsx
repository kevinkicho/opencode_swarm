...
// Sub-views for the routing modal.
//
// BudgetBar / DispatchStack / CeilingRow are pure renders driven by
// props. ObservationTooltip is the eyebrow tooltip body — long-form
// explainer for "this panel is observation, not control."
//
// Lifted from routing-modal.tsx 2026-04-28 along with the shared
// provider-fill / accent-stripe constants and the initialDispatch
// fixture. Modal stays the orchestration shell.
...
export const initialDispatch: DispatchSlice[] = [
...
export const accentStripe: Record<'molten' | 'mint' | 'iris', string> = {
  molten: 'bg-molten',
  mint: 'bg-mint',
  iris: 'bg-iris',
};

export const providerFill: Record<'zen' | 'go' | 'ollama', string> = {
  zen: 'bg-molten',
  go: 'bg-mint',
  ollama: 'bg-iris',
};
...
export function DispatchStack({ dispatch }: { dispatch: DispatchSlice[] }) {
  return (
